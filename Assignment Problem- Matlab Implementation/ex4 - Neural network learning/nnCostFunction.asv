...
%               first time.
%
%% backPropagation implementation using loop
for t = 1:m
    %step1 apply FP
    a1 = X(t,:)'; % 401x1
    z2 = Theta1*a1; % 25x1
...
%% backPropagation implementation using vectorization
% % %step1 FP
% % X = [ones(m,1) X];
% % a1 = X';% 5000x401
